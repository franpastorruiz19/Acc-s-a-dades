...
public class Vista_AE6 {
	...
	private JTextField txtAnyPubliCrear;
	...
	private JTextField txtAnyPubliActu;
	...
	private JTextField txtAnyNaixActu;
	private JTextField txtAnyNaixCrear;
	...
	private void initialize() {
		...
		JLabel lblAnyPubliCrear = new JLabel("Any de publicaci\u00F3: ");
		lblAnyPubliCrear.setFont(new Font("Calibri", Font.BOLD, 16));
		lblAnyPubliCrear.setBounds(10, 108, 137, 27);
		panel.add(lblAnyPubliCrear);
		
		txtAnyPubliCrear = new JTextField();
		txtAnyPubliCrear.setColumns(10);
		txtAnyPubliCrear.setBounds(157, 105, 120, 29);
		panel.add(txtAnyPubliCrear);
		
		txtEditorialCrear = new JTextField();
		txtEditorialCrear.setColumns(10);
		txtEditorialCrear.setBounds(81, 175, 196, 29);
		...
		lblEditorialCrear.setBounds(10, 178, 72, 27);
		...
		lblpagsCrear.setBounds(10, 213, 146, 27);
		panel.add(lblpagsCrear);
		
		txtPagsCrear = new JTextField();
		txtPagsCrear.setColumns(10);
		txtPagsCrear.setBounds(157, 210, 120, 29);
		panel.add(txtPagsCrear);
		
		JLabel lblAnyNaixCrear = new JLabel("Any de naixement: ");
		lblAnyNaixCrear.setFont(new Font("Calibri", Font.BOLD, 16));
		lblAnyNaixCrear.setBounds(9, 143, 137, 27);
		panel.add(lblAnyNaixCrear);
		
		txtAnyNaixCrear = new JTextField();
		txtAnyNaixCrear.setColumns(10);
		txtAnyNaixCrear.setBounds(156, 140, 120, 29);
		panel.add(txtAnyNaixCrear);
		
		JPanel pnlActualizar = new JPanel();
		pnlActualizar.setLayout(null);
		pnlActualizar.setBounds(379, 90, 481, 435);
		...
		btnActualitzar.setBounds(297, 363, 158, 46);
		...
		JLabel lblAnyPubliActu = new JLabel("Any de publicaci\u00F3: ");
		lblAnyPubliActu.setFont(new Font("Calibri", Font.BOLD, 16));
		lblAnyPubliActu.setBounds(10, 220, 137, 27);
		pnlActualizar.add(lblAnyPubliActu);
		
		txtAnyPubliActu = new JTextField();
		txtAnyPubliActu.setColumns(10);
		txtAnyPubliActu.setBounds(157, 217, 120, 29);
		pnlActualizar.add(txtAnyPubliActu);
		
		txtEditorialActu = new JTextField();
		txtEditorialActu.setColumns(10);
		txtEditorialActu.setBounds(81, 287, 196, 29);
		...
		lblEditorialActu.setBounds(10, 290, 72, 27);
		...
		JLabel lblAnyNaixActu = new JLabel("Any de naixement: ");
		lblAnyNaixActu.setFont(new Font("Calibri", Font.BOLD, 16));
		lblAnyNaixActu.setBounds(10, 255, 137, 27);
		pnlActualizar.add(lblAnyNaixActu);
		
		txtAnyNaixActu = new JTextField();
		txtAnyNaixActu.setColumns(10);
		txtAnyNaixActu.setBounds(157, 252, 120, 29);
		pnlActualizar.add(txtAnyNaixActu);
		
		JPanel pnlInfoDetallada = new JPanel();
		pnlInfoDetallada.setBounds(379, 561, 481, 127);
		...
		pnlInfoDetallada_1.setBounds(26, 436, 308, 127);
		...
		pnlMostrarInfo.setBounds(26, 591, 308, 97);
		...
		btnTancar.setBackground(Color.BLACK);
	...
	public JTextField getTxtAnyPubliCrear() {
		return txtAnyPubliCrear;
	}

	public JTextField getTxtAnyNaixCrear() {
		return txtAnyNaixCrear;
	}
	...
	public JTextField getTxtAnyPubliActu() {
		return txtAnyPubliActu;
	}


	public JTextField getTxtAnyNaixActu() {
		return txtAnyNaixActu;
	}

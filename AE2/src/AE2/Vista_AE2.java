...
public class Vista_AE2 {
	...
	/*
	 * - Mètode: mostrarCantitatDeParaules
	 * - Descripció: Aquest mètode mostra un missatge per pantalla, 
	 *   en aquest cas l'utilitzarem únicament per mostrar la quantitat de paraules . 
	 * - Paràmeters d'entrada: String missatge. 
	 * - Paràmeters d'eixida: No
	 * 
	 */
	public void mostrarQuantitatDeParaules(String missatge) {
